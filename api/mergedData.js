import { getAuthors, getSingleAuthor, deleteSingleAuthor } from './authorData';
...
const viewAuthorDetails = (authorFirebaseKey) => new Promise((resolve, reject) => {
  Promise.all([getSingleAuthor(authorFirebaseKey), getAuthors(authorFirebaseKey)])
...
const deleteAuthorBooks = (authorId) => new Promise((resolve, reject) => {
  getAuthors(authorId).then((booksArray) => {
